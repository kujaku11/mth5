...
class RunTS:
    ...
    def _validate_station_metadata(
        self, station_metadata: Union[timeseries.Station, dict]
    ):
        """
    ...
    def _validate_survey_metadata(
        self, survey_metadata: Union[timeseries.Survey, dict]
    ):
        """
    ...
    def from_obspy_stream(
        self, obspy_stream: Stream, run_metadata: Optional[timeseries.Run] = None
    ):
        """
