...
class TestReadPhoenixContinuous(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.data = cls.phx_obj.read_sequence()

        cls.original = open_phoenix(
            phx_data_path
            / "10128_2021-04-27-032436"
            / "0"
            / "10128_608783F4_0_00000001.td_150"
        )
        cls.original_data = cls.original.read()
    ...
    def test_attributes(self):
        true_dict = {
            ...
            "sample_rate_exp": 0,
            "saturated_frames": 0,
            "segment_end_time": "2021-04-27T03:36:17+00:00",
            "segment_start_time": "2021-04-27T03:30:18+00:00",
            "seq": 1,
            "sequence_list": [
                phx_data_path
                / "10128_2021-04-27-032436"
    ...
    def test_to_channel_ts(self):
        ...
        ## TODO: Need to properly test filters - skipping for now due to AppliedFilter object comparison complexity
