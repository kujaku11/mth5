...
def filename_test_cases():
    ...
    return [
        {
            "fn": metronix_path / "run_002" / "084_ADU-07e_C000_TEx_32Hz.json",
            "system_number": "084",
            "system_name": "ADU-07e",
            "channel_number": 0,
            "component": "ex",
        ...
        {
            "fn": metronix_path / "run_005" / "084_ADU-07e_C001_THx_2s.json",
            "system_number": "084",
            "system_name": "ADU-07e",
            "channel_number": 1,
            "component": "hx",
...
@pytest.mark.skipif(not test_data, reason="mth5_test_data not available")
