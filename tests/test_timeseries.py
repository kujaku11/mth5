...
class TestMTTS(unittest.TestCase):
    ...
    def test_input_type_electric(self):
        ...
        self.assertDictEqual(self.ts.metadata.to_dict(),
                             electric_meta.to_dict())
    ...
    def test_numpy_input(self):
        ...
        self.assertEqual(self.ts.ts.coords.to_index()
