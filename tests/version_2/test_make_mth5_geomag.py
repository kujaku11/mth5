...
class TestMakeMTH5FromGeomag(unittest.TestCase):
    ...
    def test_fresno_run_001_metadata(self):
        r = self.m.get_run("Fresno", "001", survey="USGS-GEOMAG")
        rm = OrderedDict(
            [
    ...
    def test_fresno_run_002_metadata(self):
        r = self.m.get_run("Fresno", "002", survey="USGS-GEOMAG")
        rm = OrderedDict(
            [
                ("channels_recorded_auxiliary", []),
                ("channels_recorded_electric", []),
    ...
    def test_fresno_run_001_hx_metadata(self):
        r = self.m.get_channel("Fresno", "001", "hx", survey="USGS-GEOMAG")
        rm = OrderedDict(
            [
                ("channel_number", 0),
                ("component", "hx"),
    ...
    def test_fresno_run_001_hy_metadata(self):
        r = self.m.get_channel("Fresno", "001", "hy", survey="USGS-GEOMAG")
        rm = OrderedDict(
            [
                ("channel_number", 0),
                ("component", "hy"),
    ...
    def test_ottowa_run_001_metadata(self):
        r = self.m.get_run("Ottowa", "001", survey="USGS-GEOMAG")
        rm = OrderedDict(
            [
                ("channels_recorded_auxiliary", []),
                ("channels_recorded_electric", []),
    ...
    def test_ottowa_run_002_metadata(self):
        r = self.m.get_run("Ottowa", "002", survey="USGS-GEOMAG")
        rm = OrderedDict(
            [
                ("channels_recorded_auxiliary", []),
                ("channels_recorded_electric", []),
    ...
    def test_ottowa_run_001_hx_metadata(self):
        r = self.m.get_channel("Ottowa", "001", "hx", survey="USGS-GEOMAG")
        rm = OrderedDict(
            [
                ("channel_number", 0),
                ("component", "hx"),
    ...
    def test_ottowa_run_001_hy_metadata(self):
        r = self.m.get_channel("Ottowa", "001", "hy", survey="USGS-GEOMAG")
        rm = OrderedDict(
            [
                ("channel_number", 0),
                ("component", "hy"),
