...
#
# not sure about this error, catch it for now.
try:
...
# You can download the transfer functions for **CAS04** and **NVR08** from [IRIS SPUD EMTF](http://ds.iris.edu/spud/emtf).  
# This has already been done as EMTF XML format and will be loaded here. Not true, need to scrap from SPUD
