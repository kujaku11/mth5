...
.. important:: This usage describes using MTH5 version 0.2.0 where `Survey` is the top level of the MTH5 file structure.  The current version is 0.2.0.  Some version 0.1.0 files have been archived and this is here for reference.
